...
public class RBActivity extends Activity {
	...
	/**
	 * String to indicate the (URL of the) directory for the offline data.
	 */
	 ...
	 * problem.
	 */
	private String parameters_filename = "input.in";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		switch(ProbSelectionActivity.getProblemSelected()) {
